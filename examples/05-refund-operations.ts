...
import { RefundPaymentCommand, GetPaymentStatusQuery, PaymentStatus } from '@ciscode/paymentkit';
...
export class RefundOperationsService {
  ...
  private async getRefundsByPayment(paymentId: string): Promise<RefundRecord[]> {
    // Fetch from database
    return [];
  }
