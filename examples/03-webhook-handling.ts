...
export class WebhookHandlerService {
  ...
  async handlePaymentSucceeded(event: WebhookEvent): Promise<void> {
    ...
    const { paymentId: _paymentId, metadata } = event.data;
  ...
  private async recordPaymentSuccess(_event: WebhookEvent): Promise<void> {
    // Record in analytics
    console.log('Recording payment success in analytics');
  }

  private async recordPaymentFailure(_event: WebhookEvent): Promise<void> {
